...
path_output_clusterizzazione = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\Bulk\\Clusterizzazione\\" + cartella_e_nome_output + ".txt"
path_output_angoli = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\Bulk\\Angoli_Distanza\\" + cartella_e_nome_output + "_angoli_distanza" + ".txt"
path_output_angoli_stat = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\Bulk\\Angoli_Statistica\\" + cartella_e_nome_output + "_angoli_distanza" + ".txt"
...
def periodicita(L = 2.99883): #L larghezza della scatola
    total = 0
...
def clusterizzazione(eps=10, min_samples=3):
...
# CARICAMENTO FILES
    ...
    for x in range(len(files_pdb)):
        ...
        #Valori di x
        distanza_asseX = np.arange(0, 3.5, 3)
        ...
        path_output_immagini = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\Clusterizzazione_Angoli_H2O_in_funzione_della_distanza\\Plot_angoli\\" + nome_immagine + ".png"
        ...
        plt.plot(distanza_asseX, angoli_isole_medio_distanza, 'bo', distanza_asseX, angoli_layers_medio_distanza, 'rs', linewidth=1, markersize=8, mfc='none')
        ...
        plt.xticks(np.arange(0, 3.5, 3), rotation=30)
        ...
        plt.legend(['Isole', 'Layers'], loc='upper right')
        ...
        path_output_immagini = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\Clusterizzazione_Angoli_H2O_in_funzione_della_distanza\\Plot_std\\" + nome_immagine + ".png"
        # Vado a plottare isole,layers,rumore in un unico grafico, per ognuno di essi va inserita prima la X(distanza)
        # Gli ultimi tre parametri sono grafici, l'ultimo setta su non il "riempimento" dei simboli, che altrimenti sarebbero pieni
        plt.plot(distanza_asseX, angoli_isole_medio_std, 'bo', distanza_asseX, angoli_layers_medio_std, 'rs', linewidth=1, markersize=8, mfc='none')
        # L'immagine avrà una griglia tratteggiata
        plt.grid(True, linestyle='--')
        # Setto i "divisori" in ogni asse,  con i relativi step ed eventuale rotazione(utile se ci sono sovrapposizioni)
        plt.xticks(np.arange(0, 3.5, 3), rotation=30)
...
"""
        ...
        path_output_istogrammi_angoli = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\Clusterizzazione_Angoli_H2O_in_funzione_della_distanza\\Angoli_Istogrammi\\" + nome_immagine + "\\"
        for distanza_istogrammi in np.arange(0, 3.5, 3):
            # ISOLE
