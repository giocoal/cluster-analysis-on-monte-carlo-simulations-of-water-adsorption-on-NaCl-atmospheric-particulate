    ...
    for x in range(len(files_pdb)):
        ...
        if funzione_della_distanza_onoff == "ON":
            ...
            for distanza_plot_angoli in np.arange(6.5, 25.5, 0.5):
                ...
                lista_size_marker_isole.append((np.count_nonzero(~np.isnan(angoli_isole_distanza_database[counter_plot_angoli])))**0.5)
                #lista_size_marker_layers.append([])
                lista_size_marker_layers.append((np.count_nonzero(~np.isnan(angoli_layers_distanza_database[counter_plot_angoli])))**0.5)
                #lista_size_marker_rumore.append([])
                lista_size_marker_rumore.append((np.count_nonzero(~np.isnan(angoli_rumore_distanza_database[counter_plot_angoli])))**0.5)
            ...
            plt.scatter(distanza_asseX, angoli_layers_medio_distanza, marker="s", facecolors='r', edgecolors='k',linewidths=1,s=s1)
            plt.scatter(distanza_asseX, angoli_isole_medio_distanza, marker="o", facecolors='b', edgecolors='k',linewidths=1,s=s)
            plt.scatter(distanza_asseX, angoli_rumore_medio_distanza, marker="x", facecolors='m',linewidths=1,s=s2)
...
, ha='center'
            ...
            plt.scatter(distanza_asseX, angoli_layers_medio_std, marker="s", facecolors='r', edgecolors='k')
            plt.scatter(distanza_asseX, angoli_isole_medio_std, marker="o", facecolors='b', edgecolors='k')
        ...
        if funzione_della_distanza_onoff == "ON" and calcolo_angoli_onoff == "ON":
            ...
            for distanza_istogrammi in np.arange(6.5, 25.5, 0.5):
                ...
                if unità_di_misura_angoli == "COSENO":
                    ...
                    plt.close()
                    # LAYERS
                    plt.hist((angoli_layers_distanza_database[counter_istogrammi_angoli]), bins=20, range=(-1.2,1.2),
                             weights=np.ones(len(angoli_layers_distanza_database[counter_istogrammi_angoli])) /
                    ...
                    plt.close()
                    # RUMORE
                    plt.hist((angoli_rumore_distanza_database[counter_istogrammi_angoli]), bins=20, range=(-1.2,1.2),
                             weights=np.ones(len(angoli_rumore_distanza_database[counter_istogrammi_angoli])) / len(
