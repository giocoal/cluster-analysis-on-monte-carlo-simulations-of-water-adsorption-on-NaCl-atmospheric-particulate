...
if tipo_di_ambiente == "BULK":
    path_cartella = 'C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Dati\\Bulk\\' + cartella_e_nome_output  # cartella contenente i files.pdb
#PATH OUTPUT
if funzione_della_distanza_onoff == "ON" and calcolo_angoli_onoff == "ON":
    path_output_clusterizzazione = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\FINALE\\Clusterizzazione_Angoli_H2O_in_funzione_della_distanza\\Clusterizzazione\\" + cartella_e_nome_output + ".txt"
    path_output_angoli = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\FINALE\\Clusterizzazione_Angoli_H2O_in_funzione_della_distanza\\Angoli_Distanza\\" + cartella_e_nome_output + "_angoli_distanza" + ".txt"
    path_output_angoli_stat = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\FINALE\\Clusterizzazione_Angoli_H2O_in_funzione_della_distanza\\Angoli_Statistica\\" + cartella_e_nome_output + "_angoli_distanza" + ".txt"
    path_plot_angoli_f_distanza = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\FINALE\\Clusterizzazione_Angoli_H2O_in_funzione_della_distanza\\Plot_angoli\\"
    path_plot_std_f_distanza = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\FINALE\\Clusterizzazione_Angoli_H2O_in_funzione_della_distanza\\Plot_std\\"
    path_istogrammi = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\FINALE\\Clusterizzazione_Angoli_H2O_in_funzione_della_distanza\\Angoli_Istogrammi\\"
    path_clusterizzazione_plot = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\FINALE\\Clusterizzazione_Angoli_H2O_in_funzione_della_distanza\\Clusterizzazione_plot\\"
if funzione_della_distanza_onoff == "OFF" and calcolo_angoli_onoff == "ON":
    path_output_clusterizzazione = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\FINALE\\Clusterizzazione_Angoli_H2O\\Clusterizzazione\\" + cartella_e_nome_output + ".txt"
    path_output_angoli = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\FINALE\\Clusterizzazione_Angoli_H2O\\Angoli\\" + cartella_e_nome_output + "_angoli_distanza" + ".txt"
    path_output_angoli_stat = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\FINALE\\Clusterizzazione_Angoli_H2O\\Angoli_Statistica\\" + cartella_e_nome_output + "_angoli_distanza" + ".txt"
    path_istogrammi = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\FINALE\\Clusterizzazione_Angoli_H2O\\Angoli_Istogrammi\\"
    path_clusterizzazione_plot = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\FINALE\\Clusterizzazione_Angoli_H2O\\Clusterizzazione_plot\\"

if funzione_della_distanza_onoff == "OFF" and calcolo_angoli_onoff == "OFF":
    path_output_clusterizzazione = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\FINALE\\Clusterizzazione\\" + cartella_e_nome_output + ".txt"
    path_clusterizzazione_plot = "C:\\Users\\Giorgio\\Desktop\\Tirocinio\\Risultati\\FINALE\\Clusterizzazione\\Clusterizzazione_plot\\"
    ...
    for x in range(len(files_pdb)):
        ...
        if funzione_della_distanza_onoff == "ON":
            ...
            if (files_pdb[x])[-17:-4] == "300+300Msteps":
                ...
                troncone_numero = "2"
            nome_immagine = "Pressione_" + (files_pdb[x])[36:41] + "_Replica_" + cartella_e_nome_output[-1] + "_Milliatmosfere_Troncone_" + troncone_numero
            ...
            for distanza_plot_angoli in np.arange(6.5, 25.5, 0.5):
                ...
                lista_size_marker_isole.append(np.count_nonzero(~np.isnan(angoli_isole_distanza_database[counter_plot_angoli])))
                #lista_size_marker_layers.append([])
                lista_size_marker_layers.append(np.count_nonzero(~np.isnan(angoli_layers_distanza_database[counter_plot_angoli])))
                #lista_size_marker_rumore.append([])
                lista_size_marker_rumore.append(np.count_nonzero(~np.isnan(angoli_rumore_distanza_database[counter_plot_angoli])))
            ...
            plt.scatter(distanza_asseX, angoli_layers_medio_distanza,cmap=new_cmap_rossa, marker="o", edgecolors='k',linewidths=0.1,s=200,c=lista_size_marker_layers,alpha=1,norm=None)
            plt.scatter(distanza_asseX, angoli_isole_medio_distanza, marker="o", linewidths=0.1,s=150,cmap=new_cmap_blu,c=lista_size_marker_isole,edgecolors='k',alpha=1,norm=None)
            plt.scatter(distanza_asseX, angoli_rumore_medio_distanza, marker="x", c="m",edgecolors='k',linewidths=0.5,s=15,alpha=0.5)
            ...
            path_output_immagini = path_plot_std_f_distanza + nome_immagine + ".png"
            # Vado a plottare isole,layers,rumore in un unico grafico, per ognuno di essi va inserita prima la X(distanza)
            # Gli ultimi tre parametri sono grafici, l'ultimo setta su non il "riempimento" dei simboli, che altrimenti sarebbero pieni
            plt.subplot(gs[2, :])
            fig.text(.5, .01, "Angolo medio θ (a), e relativo valore di deviazione standard (b), tra il"+"\n"+
"vettore momento di dipolo dell'acqua ed il vettore normale alla"+"\n"+
"superficie di NaCl(°), in funzione della distanza dalla superficie"
, ha='center'
                ,
                wrap=True, fontsize=11, style='oblique',
                weight='normal', verticalalignment="bottom")
            plt.title("(b)", loc="left")
            s = np.array([2,3,4,5,6,7,8,8,1,2,4,6])**2
            plt.scatter(distanza_asseX, angoli_layers_medio_std, marker="s", facecolors=rosso_standard, edgecolors='k',linewidths=0.5)
            plt.scatter(distanza_asseX, angoli_isole_medio_std, marker="o", facecolors=blu_standard, edgecolors='k',linewidths=0.5)
            plt.scatter(distanza_asseX, angoli_rumore_medio_std, marker="x", facecolors='m', edgecolors='none',s=15)
            # L'immagine avrà una griglia tratteggiata
            plt.grid(True, linestyle='--',linewidth=0.5)
            # Setto i "divisori" in ogni asse,  con i relativi step ed eventuale rotazione(utile se ci sono sovrapposizioni)
            if unità_di_misura_angoli == "GRADI":
        ...
        if funzione_della_distanza_onoff == "ON" and calcolo_angoli_onoff == "ON":
            ...
            for distanza_istogrammi in np.arange(6.5, 25.5, 0.5):
                if unità_di_misura_angoli == "GRADI":
                    # ISOLE
                    plt.hist((angoli_isole_distanza_database[counter_istogrammi_angoli]), bins=18, range=(0, 190),
                             weights=np.ones(np.count_nonzero(~np.isnan(angoli_isole_distanza_database[counter_istogrammi_angoli]))) / (np.count_nonzero(~np.isnan(angoli_isole_distanza_database[counter_istogrammi_angoli]))),normed=0)
                    ...
                    plt.close()
                    # LAYERS
                    plt.hist((angoli_layers_distanza_database[counter_istogrammi_angoli]), bins=18, range=(0, 190),
                             weights=np.ones(len(angoli_layers_distanza_database[counter_istogrammi_angoli])) /
                                     len(angoli_layers_distanza_database[counter_istogrammi_angoli]))
                    plt.gca().yaxis.set_major_formatter(PercentFormatter(1))
                    plt.xticks(np.arange(0, 190, 10), rotation=30)
                    plt.xlabel('θ(°)')
                    plt.ylabel('Frequenza')
                    ...
                    plt.close()
                    # RUMORE
                    plt.hist((angoli_rumore_distanza_database[counter_istogrammi_angoli]), bins=18, range=(0, 190),
                             weights=np.ones(len(angoli_rumore_distanza_database[counter_istogrammi_angoli])) / len(
                                 angoli_rumore_distanza_database[counter_istogrammi_angoli]))
                    plt.gca().yaxis.set_major_formatter(PercentFormatter(1))
                    plt.xticks(np.arange(0, 190, 10), rotation=30)
                    plt.xlabel('θ(°)')
                    plt.ylabel('Frequenza')
                ...
                if unità_di_misura_angoli == "COSENO":
                    ...
                    plt.hist((angoli_isole_distanza_database1[~np.isnan(angoli_isole_distanza_database1)]), bins=20, range=(-1.,1.),
                            weights=np.ones(np.count_nonzero(~np.isnan(angoli_isole_distanza_database[counter_istogrammi_angoli]))) / (np.count_nonzero(~np.isnan(angoli_isole_distanza_database[counter_istogrammi_angoli]))),density=0)
                    ...
                    plt.close()
                    # LAYERS
                    plt.hist((angoli_layers_distanza_database[counter_istogrammi_angoli]), bins=20, range=(-1.,1.),
                             weights=np.ones(len(angoli_layers_distanza_database[counter_istogrammi_angoli])) /
                                     len(angoli_layers_distanza_database[counter_istogrammi_angoli]),normed=0)
                    plt.gca().yaxis.set_major_formatter(PercentFormatter(1,decimals=2))
                    plt.xticks(np.arange(-1, 1.2, 0.2), rotation=30)
                    plt.xlabel('cosθ')
                    plt.ylabel('Frequenza')
                    ...
                    plt.close()
                    # RUMORE
                    plt.hist((angoli_rumore_distanza_database[counter_istogrammi_angoli]), bins=20, range=(-1.,1.),
                             weights=np.ones(len(angoli_rumore_distanza_database[counter_istogrammi_angoli])) / len(
                                 angoli_rumore_distanza_database[counter_istogrammi_angoli]),normed=0)
                    plt.gca().yaxis.set_major_formatter(PercentFormatter(1,decimals=2))
                    plt.xticks(np.arange(-1, 1.2, 0.2), rotation=30)
                    plt.xlabel('cosθ')
                    plt.ylabel('Frequenza')
        ...
        if funzione_della_distanza_onoff == "OFF" and calcolo_angoli_onoff == "ON":
            ...
            if unità_di_misura_angoli == "COSENO":
                path_output_istogrammi_angoli = path_istogrammi
                # ISOLE
                plt.hist((angoli_isole_distanza_database), bins=20, range=(-1.2,1.2),
                ...
                plt.close()
                # LAYERS
                plt.hist((angoli_layers_distanza_database), bins=20, range=(-1.2,1.2),
                ...
                plt.close()
                # RUMORE
                plt.hist((angoli_rumore_distanza_database), bins=20, range=(-1.2,1.2),
