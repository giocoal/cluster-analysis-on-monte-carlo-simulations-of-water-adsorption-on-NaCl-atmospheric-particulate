...
path_data = './Dati/History/'
pression = "9000"
history_file_name = f'{path_data}HISTORY.000_{pression}matm'

def getSize(inputFile):
    size = os.path.getsize(history_file_name)
    print(size)
    return size
...
inputmmc = open(history_file_name, "r")
...
pressione_point = pression[0]+"."+pression[1:4]
pdb = open(f"{path_data}Simulazione_Celsius24_Milliatmosfere{pressione_point}_5Layers4Mobili_300+300Msteps.pdb", "w")
pdb.write('REMARK ')
