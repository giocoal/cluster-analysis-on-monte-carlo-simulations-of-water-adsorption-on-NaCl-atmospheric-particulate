...
hystory_name = 'HISTORY.000_7500matm'

inputmmc = open(hystory_name, "r")
...
path_attuale = sys.path 
#nome_file_pdb = "/home/grecocla/CarboneGiorgio/Solo_H2O/" + os.path.basename(path_attuale[0]) + ".pdb" 
nome_file_pdb = f"./f{hystory_name}.pdb"
pdb = open(nome_file_pdb,"w")
pdb.write('REMARK ')
